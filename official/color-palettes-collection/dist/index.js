...
function s() {
  Object.keys(o).forEach((e) => delete o[e]), c.forEach((e, a) => {
    o[a] = e;
  });
}
function i(e) {
...
Chaque palette a été conçue pour maximiser la lisibilité et l'impact visuel de vos idées. Que vous créiez une présentation professionnelle, organisiez un brainstorming créatif ou structuriez un projet technique, vous trouverez la palette parfaite pour votre contexte.`,
  ...
  featured: !0,
  autoActivate: !0,
  // Auto-activate on first launch (essential for colors)
  license: "MIT",
  ...
  changelog: [
    {
      ...
      changes: [
        ...
        {
          type: "added",
          description: "8 palettes essentielles (Vibrant, Pastel, Earth, Neon, Ocean, Rainbow, Monochrome, Material)"
        },
        {
          type: "added",
